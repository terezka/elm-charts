...
var _terezka$elm_plot$Plot_Interaction$getRelativePosition = F4(
	function (_p1, _p0, left, top) {
		var _p2 = _p1;
		var _p3 = _p0;
		var _p4 = _p2.fromSvgCoords(
			{ctor: '_Tuple2', _0: _p3._0 - left, _1: _p3._1 - top});
		var x = _p4._0;
		var y = _p4._1;
		return {
			ctor: '_Tuple2',
...
var _terezka$elm_plot$Plot_Interaction$initialState = {position: _elm_lang$core$Maybe$Nothing, waiting: false};
var _terezka$elm_plot$Plot_Interaction$State = F2(
	function (a, b) {
		return {position: a, waiting: b};
	});
var _terezka$elm_plot$Plot_Interaction$None = {ctor: 'None'};
var _terezka$elm_plot$Plot_Interaction$ResetPosition = {ctor: 'ResetPosition'};
var _terezka$elm_plot$Plot_Interaction$ReceivePosition = function (a) {
	return {ctor: 'ReceivePosition', _0: a};
};
var _terezka$elm_plot$Plot_Interaction$getPosition = F2(
	function (meta, eventPosition) {
		return A2(
			_elm_lang$core$Task$attempt,
			_terezka$elm_plot$Plot_Interaction$ReceivePosition,
			A3(
				_elm_lang$core$Task$map2,
				A2(_terezka$elm_plot$Plot_Interaction$getRelativePosition, meta, eventPosition),
				_terezka$elm_plot$Dom_Position$left(meta.id),
				_terezka$elm_plot$Dom_Position$top(meta.id)));
	});
var _terezka$elm_plot$Plot_Interaction$update = F2(
	function (msg, state) {
		var _p5 = msg;
		switch (_p5.ctor) {
			case 'Hovering':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						state,
						{waiting: true}),
					_1: A2(_terezka$elm_plot$Plot_Interaction$getPosition, _p5._0, _p5._1)
				};
				...
				if (_p6.ctor === 'Ok') {
					return state.waiting ? {
						...
						_0: _elm_lang$core$Native_Utils.update(
							state,
							{
								position: _elm_lang$core$Maybe$Just(_p6._0)
							}),
...
var _terezka$elm_plot$Plot_Interaction$Hovering = F2(
	function (a, b) {
...
var _terezka$elm_plot$Plot_Grid$viewLine = F3(
	function (_p0, style, position) {
		var _p1 = _p0;
		var _p5 = _p1.toSvgCoords;
		var _p2 = _p1.scale;
		var lowest = _p2.lowest;
		var highest = _p2.highest;
		var _p3 = _p5(
...
var _terezka$elm_plot$Plot_Grid$getPositions = F2(
	function (tickValues, values) {
		var _p6 = values;
		if (_p6.ctor === 'MirrorTicks') {
			return tickValues;
		} else {
			return _p6._0;
		}
	});
var _terezka$elm_plot$Plot_Grid$view = F2(
	function (meta, _p7) {
		var _p8 = _p7;
		var _p9 = meta;
		var scale = _p9.scale;
		...
		var positions = A2(_terezka$elm_plot$Plot_Grid$getPositions, oppositeTicks, _p8.values);
		return A2(
			_elm_lang$svg$Svg$g,
			{
				ctor: '::',
			...
			A2(
				_elm_lang$core$List$map,
				A2(_terezka$elm_plot$Plot_Grid$viewLine, meta, _p8.style),
				positions));
	});
...
var _terezka$elm_plot$Plot_Grid$CustomValues = function (a) {
	return {ctor: 'CustomValues', _0: a};
};
var _terezka$elm_plot$Plot_Grid$values = F2(
	function (values, config) {
		return _elm_lang$core$Native_Utils.update(
			config,
			{
				values: _terezka$elm_plot$Plot_Grid$CustomValues(values)
			});
	});
var _terezka$elm_plot$Plot_Grid$MirrorTicks = {ctor: 'MirrorTicks'};
var _terezka$elm_plot$Plot_Grid$defaultConfigX = {
	values: _terezka$elm_plot$Plot_Grid$MirrorTicks,
	style: {ctor: '[]'},
	classes: {ctor: '[]'},
	orientation: _terezka$elm_plot$Plot_Types$X
};
var _terezka$elm_plot$Plot_Grid$defaultConfigY = _elm_lang$core$Native_Utils.update(
	_terezka$elm_plot$Plot_Grid$defaultConfigX,
	{orientation: _terezka$elm_plot$Plot_Types$Y});
var _terezka$elm_plot$Plot_Grid$toConfigY = function (attrs) {
	return A3(
		_elm_lang$core$List$foldr,
		F2(
			function (x, y) {
...
var _terezka$elm_plot$Plot$getAxisConfig = F3(
	function (orientation, element, lastConfig) {
		...
		if (_p4.ctor === 'Axis') {
			var _p5 = _p4._0;
			return _elm_lang$core$Native_Utils.eq(_p5.orientation, orientation) ? _elm_lang$core$Maybe$Just(_p5) : lastConfig;
		} else {
			return lastConfig;
		}
	});
...
var _terezka$elm_plot$Plot$unScaleValue = F2(
	function (_p6, v) {
		var _p7 = _p6;
		return ((v - _p7.offset) * _p7.range) / _p7.length;
	});
var _terezka$elm_plot$Plot$fromSvgCoords = F3(
	function (xScale, yScale, _p8) {
		...
		return {
			ctor: '_Tuple2',
			_0: A2(_terezka$elm_plot$Plot$unScaleValue, xScale, _p9._0),
			_1: A2(_terezka$elm_plot$Plot$unScaleValue, yScale, yScale.length - _p9._1)
		};
	});
var _terezka$elm_plot$Plot$scaleValue = F2(
	function (_p10, v) {
		var _p11 = _p10;
		return ((v * _p11.length) / _p11.range) + _p11.offset;
	});
...
var _terezka$elm_plot$Plot$getScale = F4(
	function (lengthTotal, _p17, _p16, values) {
		var _p18 = _p17;
		var _p20 = _p18._0;
		var _p19 = _p16;
		...
		var length = (lengthTotal - _p20) - _p18._1;
		var paddingTop = A3(_terezka$elm_plot$Helpers$pixelsToValue, length, range, _p19._1);
		var paddingBottom = A3(_terezka$elm_plot$Helpers$pixelsToValue, length, range, _p19._0);
		return {lowest: lowest - paddingBottom, highest: highest + paddingTop, range: (range + paddingBottom) + paddingTop, length: length, offset: _p20};
	});
var _terezka$elm_plot$Plot$flipToY = function (_p21) {
	var _p22 = _p21;
	return _elm_lang$core$Native_Utils.update(
		_p22,
		{scale: _p22.oppositeScale, oppositeScale: _p22.scale, toSvgCoords: _p22.oppositeToSvgCoords, oppositeToSvgCoords: _p22.toSvgCoords, ticks: _p22.oppositeTicks, oppositeTicks: _p22.ticks});
};
var _terezka$elm_plot$Plot$getFlippedMeta = F2(
	function (orientation, meta) {
		var _p23 = orientation;
		if (_p23.ctor === 'X') {
			return meta;
		} else {
...
var _terezka$elm_plot$Plot$calculateMeta = F2(
	function (_p24, elements) {
		var _p25 = _p24;
		var _p26 = _p25.margin;
		var top = _p26._0;
		var right = _p26._1;
		var bottom = _p26._2;
		var left = _p26._3;
		...
		var width = _p27._0;
		var height = _p27._1;
		var _p28 = _elm_lang$core$List$unzip(
			A3(
				_elm_lang$core$List$foldr,
		...
		switch (_p31.ctor) {
			case 'Line':
				return {
					...
					_0: {
						ctor: '::',
						_0: A3(_terezka$elm_plot$Plot_Line$view, meta, _p31._0, _p31._1),
						_1: _p34
					},
					_1: _p33
				};
			case 'Area':
				return {
					...
					_0: {
						ctor: '::',
						_0: A3(_terezka$elm_plot$Plot_Area$view, meta, _p31._0, _p31._1),
						_1: _p34
					},
					_1: _p33
				};
				...
				return {
					...
					_0: {
						...
						_0: A2(
							...
							A2(_terezka$elm_plot$Plot$getFlippedMeta, _p31._0.orientation, meta),
							_p31._0),
						_1: _p34
					},
					_1: _p33
			...
			case 'Grid':
				return {
					...
					_0: {
						ctor: '::',
						_0: A2(
							_terezka$elm_plot$Plot_Grid$view,
							A2(_terezka$elm_plot$Plot$getFlippedMeta, _p31._0.orientation, meta),
							_p31._0),
						_1: _p34
					},
			...
			default:
				...
				if (_p32.ctor === 'Just') {
					return {
						...
						_1: {
							ctor: '::',
							_0: A3(_terezka$elm_plot$Plot_Tooltip$view, meta, _p31._0, _p32._0),
							_1: _p33
						}
					};
				} else {
...
var _terezka$elm_plot$Plot$getRelativePosition = F4(
	function (_p36, _p35, left, top) {
		var _p37 = _p36;
		var _p38 = _p35;
		var _p39 = _p37.fromSvgCoords(
			{ctor: '_Tuple2', _0: _p38._0 - left, _1: _p38._1 - top});
		var x = _p39._0;
		var y = _p39._1;
		return {
			ctor: '_Tuple2',
...
var _terezka$elm_plot$Plot$horizontalGrid = function (attrs) {
	return _terezka$elm_plot$Plot$Grid(
		_terezka$elm_plot$Plot_Grid$toConfigX(attrs));
};
var _terezka$elm_plot$Plot$verticalGrid = function (attrs) {
	return _terezka$elm_plot$Plot$Grid(
		_terezka$elm_plot$Plot_Grid$toConfigY(attrs));
};
			...
			case 'Hovering':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						state,
						{waiting: true}),
					_1: A2(_terezka$elm_plot$Plot$getPosition, _p40._0, _p40._1)
				};
			case 'ReceivePosition':
				var _p41 = _p40._0;
				if (_p41.ctor === 'Ok') {
					return state.waiting ? {
						...
						_0: _elm_lang$core$Native_Utils.update(
							state,
							{
								position: _elm_lang$core$Maybe$Just(_p41._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					} : {ctor: '_Tuple2', _0: state, _1: _elm_lang$core$Platform_Cmd$none};
				} else {
...
var _terezka$elm_plot$Plot$viewPlot = F3(
	function (_p43, meta, _p42) {
		var _p44 = _p43;
		var _p45 = _p42;
		var _p46 = _p44.margin;
		var top = _p46._0;
		var right = _p46._1;
		var bottom = _p46._2;
		var left = _p46._3;
	...
	_1: {
		...
		_1: {
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 4, _1: 20},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 5, _1: 25},
						_1: {
							ctor: '::',
...
var _terezka$elm_plot$Test$toTickConfig = F2(
	function (index, tick) {
		return _terezka$elm_plot$Test$isOdd(index) ? {
			ctor: '::',
			_0: _terezka$elm_plot$Plot_Tick$length(7),
			_1: {
				ctor: '::',
				_0: _terezka$elm_plot$Plot_Tick$style(
					{
						ctor: '::',
...
var _terezka$elm_plot$Test$toLabelConfig = F2(
	function (index, tick) {
		return _terezka$elm_plot$Test$isOdd(index) ? {
			ctor: '::',
			...
			_1: {
				ctor: '::',
				_0: _terezka$elm_plot$Plot_Label$style(
					{
						ctor: '::',
...
var _terezka$elm_plot$Test$data = {
	ctor: '::',
				...
				_0: _terezka$elm_plot$Plot$xAxis(
					{
						...
						_1: {
							...
							_0: _terezka$elm_plot$Plot_Axis$tick(
								{
									ctor: '::',
									_0: _terezka$elm_plot$Plot_Tick$viewDynamic(_terezka$elm_plot$Test$toTickConfig),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: _terezka$elm_plot$Plot_Axis$label(
									{
										ctor: '::',
										_0: _terezka$elm_plot$Plot_Label$viewDynamic(_terezka$elm_plot$Test$toLabelConfig),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
					...
					_0: _terezka$elm_plot$Plot$yAxis(
						{
							...
							_1: {
								...
								_0: _terezka$elm_plot$Plot_Axis$tick(
									{
										ctor: '::',
										_0: _terezka$elm_plot$Plot_Tick$viewCustom(_terezka$elm_plot$Test$specialTick),
										_1: {
											ctor: '::',
...
var _terezka$elm_plot$Docs$PlotMsg = function (a) {
	return {ctor: 'PlotMsg', _0: a};
};
var _terezka$elm_plot$Docs$update = F2(
	function (msg, model) {
		...
		if (_p0.ctor === 'Toggle') {
			...
			var _p1 = A2(_terezka$elm_plot$Plot$update, _p0._0, model.plotState);
			var state = _p1._0;
			var cmd = _p1._1;
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{plotState: state}),
				_1: A2(_elm_lang$core$Platform_Cmd$map, _terezka$elm_plot$Docs$PlotMsg, cmd)
			};
		}
	});
...
var _terezka$elm_plot$Docs$viewTitle = F4(
	function (_p2, title, name, codeString) {
		var _p3 = _p2;
		var isOpen = function () {
			var _p4 = _p3.openSection;
			if (_p4.ctor === 'Just') {
				return _elm_lang$core$Native_Utils.eq(_p4._0, title);
			} else {
				return false;
			}
		}();
					...
					_1: {
						...
						_1: {
							...
							_0: A2(
								...
								_terezka$elm_plot$Docs$PlotMsg,
								_terezka$elm_plot$Test$chart(_terezka$elm_plot$Plot$initialState)),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$map,
									_terezka$elm_plot$Docs$PlotMsg,
									_terezka$elm_plot$AreaChart$chart(model.plotState)),
								_1: {
									ctor: '::',
									_0: A2(
										_elm_lang$html$Html$div,
