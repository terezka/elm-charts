...
var _terezka$elm_plot$Plot$toTickValuesFromDelta = F2(
	function (delta, _p5) {
		...
		return A2(
			...
			_elm_lang$core$Native_List.range(0, tickCount));
	});
...
var _terezka$elm_plot$Plot$viewArea = F2(
	function (_p24, _p23) {
		var _p25 = _p24;
		var _p31 = _p25.toSvgCoords;
		var _p26 = _p23;
		var _p30 = _p26.points;
		var svgCoords = A2(_elm_lang$core$List$map, _p31, _p30);
		var instructions = A2(_terezka$elm_plot$Helpers$coordToInstruction, 'L', svgCoords);
		var range = A2(_elm_lang$core$List$map, _elm_lang$core$Basics$fst, _p30);
		var _p27 = {
			ctor: '_Tuple2',
		...
		var lowestX = _p27._0;
		var highestX = _p27._1;
		var _p28 = _p31(
			{ctor: '_Tuple2', _0: highestX, _1: 0});
		var highestSvgX = _p28._0;
		var originY = _p28._1;
...
var _terezka$elm_plot$Plot$viewGridLine = F4(
	function (toSvgCoords, scale, style, position) {
		var _p32 = scale;
		var lowest = _p32.lowest;
		var highest = _p32.highest;
		var _p33 = toSvgCoords(
			{ctor: '_Tuple2', _0: lowest, _1: position});
		var x1 = _p33._0;
		var y1 = _p33._1;
		var _p34 = toSvgCoords(
...
var _terezka$elm_plot$Plot$viewGrid = F2(
	function (_p37, _p36) {
		var _p38 = _p37;
		var _p39 = _p36;
		var positions = A2(_terezka$elm_plot$Plot$getGridPositions, _p38.oppositeTicks, _p39.gridValues);
		return A2(
			_elm_lang$svg$Svg$g,
			_elm_lang$core$Native_List.fromArray(
				[]),
			A2(
				_elm_lang$core$List$map,
				A3(_terezka$elm_plot$Plot$viewGridLine, _p38.toSvgCoords, _p38.scale, _p39.gridStyle),
				positions));
	});
var _terezka$elm_plot$Plot$defaultLabelStyleY = {
	...
	_0: _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'text-anchor', _1: 'end'}
		]),
...
var _terezka$elm_plot$Plot$defaultLabelStyleX = {
	...
	_0: _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'text-anchor', _1: 'middle'}
		]),
	_1: {ctor: '_Tuple2', _0: 0, _1: 24}
};
var _terezka$elm_plot$Plot$defaultLabelView = F4(
	function (_p40, orientation, index, tick) {
		var _p41 = _p40;
		var _p42 = A3(
			F2(
				function (x, y) {
		...
		var defaultStyle = _p42._0;
		var defaultDisplacement = _p42._1;
		var _p43 = A2(_elm_lang$core$Maybe$withDefault, defaultDisplacement, _p41.displace);
		var dx = _p43._0;
		var dy = _p43._1;
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_terezka$elm_plot$Helpers$toStyle(
						A2(_elm_lang$core$Basics_ops['++'], defaultStyle, _p41.style)))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$svg$Svg$text(
							A2(_p41.format, index, tick))
						]))
				]));
	});
var _terezka$elm_plot$Plot$defaultTickView = F4(
	function (_p46, orientation, _p45, _p44) {
		var _p47 = _p46;
		var styleFinal = A2(
			_elm_lang$core$Basics_ops['++'],
			_p47.style,
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_1: A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(_p47.width),
						'px')
				}
				]));
		var displacement = A3(
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$svg$Svg_Attributes$y2(
					_elm_lang$core$Basics$toString(_p47.length)),
					_elm_lang$svg$Svg_Attributes$transform(displacement)
				]),
			_elm_lang$core$Native_List.fromArray(
				[]));
	});
var _terezka$elm_plot$Plot$placeTick = F3(
	function (_p49, view, _p48) {
		var _p50 = _p49;
		var _p51 = _p48;
		var _p52 = _p51._1;
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_terezka$elm_plot$Helpers$toTranslate(
						_p50.toSvgCoords(
							{ctor: '_Tuple2', _0: _p52, _1: 0})))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(view, _p51._0, _p52)
				]));
	});
...
var _terezka$elm_plot$Plot$viewAxis = F2(
	function (plotProps, _p53) {
		var _p54 = _p53;
		var _p59 = _p54.orientation;
		var _p55 = plotProps;
		var scale = _p55.scale;
		var oppositeScale = _p55.oppositeScale;
		var toSvgCoords = _p55.toSvgCoords;
		var oppositeToSvgCoords = _p55.oppositeToSvgCoords;
		var tickPositions = _terezka$elm_plot$Plot$indexTicks(
			A2(
				_terezka$elm_plot$Plot$filterTicks,
				_p54.axisCrossing,
				_p54.toTickValues(scale)));
		var labelPositions = function () {
			var _p56 = _p54.labelValues;
			if (_p56.ctor === 'LabelCustomValues') {
				return _terezka$elm_plot$Plot$indexTicks(_p56._0);
			} else {
				return A2(
					_elm_lang$core$List$filter,
					function (_p57) {
						var _p58 = _p57;
						return A2(_p56._0, _p58._0, _p58._1);
					},
					tickPositions);
			}
		}();
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$svg$Svg_Attributes$style(
					_terezka$elm_plot$Helpers$toStyle(_p54.style))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A4(_terezka$elm_plot$Plot$viewGridLine, toSvgCoords, scale, _p54.axisLineStyle, 0),
					A2(
					_elm_lang$svg$Svg$g,
					_elm_lang$core$Native_List.fromArray(
						[]),
	...
	function (plotProps, element, views) {
		...
		switch (_p60.ctor) {
			case 'Axis':
				...
				return A2(
					_elm_lang$core$List_ops['::'],
					A2(_terezka$elm_plot$Plot$viewAxis, plotPropsFitted, _p62),
					views);
			case 'Grid':
				var _p64 = _p60._0;
				var plotPropsFitted = function () {
					var _p63 = _p64.orientation;
					if (_p63.ctor === 'X') {
						return plotProps;
					} else {
						return _terezka$elm_plot$Plot$flipToY(plotProps);
				...
				return A2(
					_elm_lang$core$List_ops['::'],
					A2(_terezka$elm_plot$Plot$viewGrid, plotPropsFitted, _p64),
					views);
			case 'Line':
				return A2(
					_elm_lang$core$List_ops['::'],
					A2(_terezka$elm_plot$Plot$viewLine, plotProps, _p60._0),
					views);
			default:
				return A2(
					_elm_lang$core$List_ops['::'],
					A2(_terezka$elm_plot$Plot$viewArea, plotProps, _p60._0),
					views);
		}
	});
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$svg$Svg_Attributes$style(
					_terezka$elm_plot$Helpers$toStyle(_p66.style))
				]),
			children);
	});
	...
	function (style, config) {
		return _elm_lang$core$Native_Utils.update(
			config,
			{
				style: A2(
					_elm_lang$core$List_ops['::'],
					{ctor: '_Tuple2', _0: 'fill', _1: 'transparent'},
					style)
			});
	});
...
var _terezka$elm_plot$Plot$MetaConfig = F3(
	function (a, b, c) {
		return {size: a, padding: b, style: c};
	});
var _terezka$elm_plot$Plot$TickViewConfig = F3(
	function (a, b, c) {
		return {length: a, width: b, style: c};
	});
var _terezka$elm_plot$Plot$LabelViewConfig = F3(
	function (a, b, c) {
		return {displace: a, format: b, style: c};
	});
var _terezka$elm_plot$Plot$AxisConfig = F8(
	function (a, b, c, d, e, f, g, h) {
		return {toTickValues: a, tickView: b, labelValues: c, labelView: d, axisLineStyle: e, axisCrossing: f, style: g, orientation: h};
	});
var _terezka$elm_plot$Plot$GridConfig = F3(
	function (a, b, c) {
		return {gridValues: a, gridStyle: b, orientation: c};
	});
...
var _terezka$elm_plot$Plot$defaultAxisConfig = {
	...
	style: _elm_lang$core$Native_List.fromArray(
		[]),
	axisLineStyle: _elm_lang$core$Native_List.fromArray(
		[]),
	axisCrossing: false,
...
var _terezka$elm_plot$Plot$getPlotProps = F2(
	function (_p75, elements) {
		...
		var yScale = A3(_terezka$elm_plot$Plot$getScales, height, _p76.padding, yValues);
...
var _terezka$elm_plot$Plot$gridValues = F2(
	function (values, config) {
		return _elm_lang$core$Native_Utils.update(
			config,
			{
				gridValues: _terezka$elm_plot$Plot$GridCustomValues(values)
			});
	});
var _terezka$elm_plot$Plot$GridMirrorTicks = {ctor: 'GridMirrorTicks'};
var _terezka$elm_plot$Plot$defaultGridConfig = {
	gridValues: _terezka$elm_plot$Plot$GridMirrorTicks,
	gridStyle: _elm_lang$core$Native_List.fromArray(
		[]),
	orientation: _terezka$elm_plot$Plot$X
};
...
var _terezka$elm_plot$AreaChart$data = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 0, _1: 8},
		{ctor: '_Tuple2', _0: 1, _1: 13},
		{ctor: '_Tuple2', _0: 2, _1: 14},
		{ctor: '_Tuple2', _0: 3, _1: 12},
		{ctor: '_Tuple2', _0: 4, _1: 11},
		{ctor: '_Tuple2', _0: 5, _1: 16},
		{ctor: '_Tuple2', _0: 6, _1: 22},
		{ctor: '_Tuple2', _0: 7, _1: 32}
	]);
var _terezka$elm_plot$AreaChart$chart = A2(
	_terezka$elm_plot$Plot$plot,
	_elm_lang$core$Native_List.fromArray(
		[
			_terezka$elm_plot$Plot$size(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_terezka$elm_plot$Plot$areaStyle(
					_elm_lang$core$Native_List.fromArray(
						[
							{ctor: '_Tuple2', _0: 'stroke', _1: _terezka$elm_plot$Colors$blueStroke},
							{ctor: '_Tuple2', _0: 'fill', _1: _terezka$elm_plot$Colors$blueFill}
						]))
				]),
			_terezka$elm_plot$AreaChart$data),
			_terezka$elm_plot$Plot$xAxis(
			_elm_lang$core$Native_List.fromArray(
				[
					_terezka$elm_plot$Plot$axisStyle(
					_elm_lang$core$Native_List.fromArray(
						[
							{ctor: '_Tuple2', _0: 'stroke', _1: _terezka$elm_plot$Colors$axisColor}
						]))
				]))
		]));
...
var _terezka$elm_plot$ComposedChart$customLabelStyle = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'stroke', _1: '#969696'},
...
var _terezka$elm_plot$ComposedChart$filterLabels = F2(
	function (index, _p0) {
		return _elm_lang$core$Basics$not(
			_terezka$elm_plot$ComposedChart$isOdd(index));
	});
var _terezka$elm_plot$ComposedChart$toTickConfig = F2(
	function (index, tick) {
		return _terezka$elm_plot$ComposedChart$isOdd(index) ? _elm_lang$core$Native_List.fromArray(
			[
				_terezka$elm_plot$Plot$tickLength(7),
				_terezka$elm_plot$Plot$tickStyle(
				_elm_lang$core$Native_List.fromArray(
					[
						{ctor: '_Tuple2', _0: 'stroke', _1: '#c7c7c7'}
					]))
			]) : _elm_lang$core$Native_List.fromArray(
			[
				_terezka$elm_plot$Plot$tickLength(10),
				_terezka$elm_plot$Plot$tickStyle(
				_elm_lang$core$Native_List.fromArray(
					[
						{ctor: '_Tuple2', _0: 'stroke', _1: '#b9b9b9'}
					]))
			]);
	});
var _terezka$elm_plot$ComposedChart$data1 = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: -10, _1: 14},
		{ctor: '_Tuple2', _0: -9, _1: 5},
		{ctor: '_Tuple2', _0: -8, _1: -9},
		{ctor: '_Tuple2', _0: -7, _1: -15},
		{ctor: '_Tuple2', _0: -6, _1: -22},
		...
		{ctor: '_Tuple2', _0: 0, _1: 14},
		{ctor: '_Tuple2', _0: 1, _1: 16},
		{ctor: '_Tuple2', _0: 2, _1: 26},
		{ctor: '_Tuple2', _0: 3, _1: 32},
		{ctor: '_Tuple2', _0: 4, _1: 28},
		{ctor: '_Tuple2', _0: 5, _1: 32},
		{ctor: '_Tuple2', _0: 6, _1: 29},
		{ctor: '_Tuple2', _0: 7, _1: 46},
		{ctor: '_Tuple2', _0: 8, _1: 52},
		{ctor: '_Tuple2', _0: 9, _1: 53},
		{ctor: '_Tuple2', _0: 10, _1: 59}
	]);
var _terezka$elm_plot$ComposedChart$chart = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_terezka$elm_plot$Plot$padding(
			{ctor: '_Tuple2', _0: 40, _1: 40})
		]),
	_elm_lang$core$Native_List.fromArray(
		[
			_terezka$elm_plot$Plot$horizontalGrid(
			_elm_lang$core$Native_List.fromArray(
				[
					_terezka$elm_plot$Plot$gridMirrorTicks,
					_terezka$elm_plot$Plot$gridStyle(
					_elm_lang$core$Native_List.fromArray(
						[
							{ctor: '_Tuple2', _0: 'stroke', _1: '#f2f2f2'}
						]))
				])),
			A2(
			_terezka$elm_plot$Plot$area,
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							{ctor: '_Tuple2', _0: 'stroke', _1: _terezka$elm_plot$Colors$skinStroke},
							{ctor: '_Tuple2', _0: 'fill', _1: _terezka$elm_plot$Colors$skinFill},
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_terezka$elm_plot$Plot$lineStyle(
					_elm_lang$core$Native_List.fromArray(
						[
							{ctor: '_Tuple2', _0: 'stroke', _1: _terezka$elm_plot$Colors$pinkStroke},
							{ctor: '_Tuple2', _0: 'stroke-width', _1: '2px'}
						]))
				]),
			A2(
				_elm_lang$core$List$map,
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_terezka$elm_plot$Plot$tickRemoveZero,
					_terezka$elm_plot$Plot$tickDelta(50),
					_terezka$elm_plot$Plot$labelConfigView(
					_elm_lang$core$Native_List.fromArray(
						[
							_terezka$elm_plot$Plot$labelFormat(
							function (l) {
								return A2(
									_elm_lang$core$Basics_ops['++'],
							...
							_terezka$elm_plot$Plot$labelStyle(_terezka$elm_plot$ComposedChart$customLabelStyle)
						]))
				])),
			_terezka$elm_plot$Plot$xAxis(
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_terezka$elm_plot$Plot$tickRemoveZero,
					_terezka$elm_plot$Plot$tickConfigViewFunc(_terezka$elm_plot$ComposedChart$toTickConfig),
					_terezka$elm_plot$Plot$labelConfigView(
					_elm_lang$core$Native_List.fromArray(
						[
							_terezka$elm_plot$Plot$labelFormat(
					...
					_terezka$elm_plot$Plot$labelFilter(_terezka$elm_plot$ComposedChart$filterLabels)
				]))
		]));
...
var _terezka$elm_plot$CustomTickChart$toTickConfig = F2(
	function (index, tick) {
		return _terezka$elm_plot$CustomTickChart$isOdd(index) ? _elm_lang$core$Native_List.fromArray(
			[
				_terezka$elm_plot$Plot$tickLength(7),
				_terezka$elm_plot$Plot$tickStyle(
				_elm_lang$core$Native_List.fromArray(
					[
						{ctor: '_Tuple2', _0: 'stroke', _1: '#e4e3e3'}
					]))
			]) : _elm_lang$core$Native_List.fromArray(
			[
				_terezka$elm_plot$Plot$tickLength(10),
	...
	function (index, tick) {
		return _terezka$elm_plot$CustomTickChart$isOdd(index) ? _elm_lang$core$Native_List.fromArray(
			...
			[
				...
				_terezka$elm_plot$Plot$labelStyle(
				_elm_lang$core$Native_List.fromArray(
					[
						{ctor: '_Tuple2', _0: 'stroke', _1: '#969696'}
					])),
				_terezka$elm_plot$Plot$labelDisplace(
				{ctor: '_Tuple2', _0: 0, _1: 27})
			]);
	});
var _terezka$elm_plot$CustomTickChart$data = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 0, _1: 14},
		{ctor: '_Tuple2', _0: 1, _1: 16},
		{ctor: '_Tuple2', _0: 2, _1: 26},
		...
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_terezka$elm_plot$Plot$tickConfigViewFunc(_terezka$elm_plot$CustomTickChart$toTickConfig),
					_terezka$elm_plot$Plot$labelConfigViewFunc(_terezka$elm_plot$CustomTickChart$toLabelConfig)
				]))
		]));

var _terezka$elm_plot$MultiAreaChart$code = '\n    chart : Svg.Svg a\n    chart =\n        plot\n            [ size ( 600, 250 ) ]\n            [ area\n                [ areaStyle\n                    [ ( \"stroke\", Colors.skinStroke )\n                    , ( \"fill\", Colors.skinFill )\n                    ]\n                ]\n                data1\n            , area\n                [ areaStyle\n                    [ ( \"stroke\", Colors.blueStroke )\n                    , ( \"fill\", Colors.blueFill )\n                    ]\n                ]\n                data2\n            , xAxis\n                [ axisStyle [ ( \"stroke\", Colors.axisColor ) ]\n                , tickDelta 10\n                ]\n            ]\n    ';
var _terezka$elm_plot$MultiAreaChart$data2 = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 0, _1: 5},
		{ctor: '_Tuple2', _0: 10, _1: 20},
		{ctor: '_Tuple2', _0: 20, _1: 10},
		{ctor: '_Tuple2', _0: 30, _1: 12},
		{ctor: '_Tuple2', _0: 40, _1: 20},
		{ctor: '_Tuple2', _0: 45, _1: 25},
		{ctor: '_Tuple2', _0: 50, _1: 3}
	]);
var _terezka$elm_plot$MultiAreaChart$data1 = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 0, _1: 10},
		{ctor: '_Tuple2', _0: 10, _1: 90},
		{ctor: '_Tuple2', _0: 20, _1: 25},
		{ctor: '_Tuple2', _0: 30, _1: 15},
		{ctor: '_Tuple2', _0: 40, _1: 66},
		{ctor: '_Tuple2', _0: 50, _1: 16}
	]);
		...
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_terezka$elm_plot$Plot$tickDelta(10)
				]))
		]));
...
var _terezka$elm_plot$GridChart$data = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 0, _1: 8},
		{ctor: '_Tuple2', _0: 1, _1: 13},
		{ctor: '_Tuple2', _0: 2, _1: 14},
		...
		{ctor: '_Tuple2', _0: 6, _1: 22},
		{ctor: '_Tuple2', _0: 7, _1: 32},
		{ctor: '_Tuple2', _0: 8, _1: 31},
		{ctor: '_Tuple2', _0: 9, _1: 37},
		{ctor: '_Tuple2', _0: 10, _1: 42}
	]);
var _terezka$elm_plot$GridChart$chart = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			_terezka$elm_plot$Plot$verticalGrid(
			_elm_lang$core$Native_List.fromArray(
				[
					_terezka$elm_plot$Plot$gridMirrorTicks,
					_terezka$elm_plot$Plot$gridStyle(
					_elm_lang$core$Native_List.fromArray(
						[
							{ctor: '_Tuple2', _0: 'stroke', _1: _terezka$elm_plot$Colors$axisColorLight}
						]))
				])),
			_terezka$elm_plot$Plot$horizontalGrid(
			_elm_lang$core$Native_List.fromArray(
				[
					_terezka$elm_plot$Plot$gridValues(
					_elm_lang$core$Native_List.fromArray(
						[10, 20, 30, 40])),
					_terezka$elm_plot$Plot$gridStyle(
					_elm_lang$core$Native_List.fromArray(
...
var _terezka$elm_plot$MultiLineChart$data2 = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 0, _1: 3},
		{ctor: '_Tuple2', _0: 1, _1: 2},
		{ctor: '_Tuple2', _0: 2, _1: 8},
		{ctor: '_Tuple2', _0: 2.5, _1: 15},
		{ctor: '_Tuple2', _0: 3, _1: 18},
		{ctor: '_Tuple2', _0: 4, _1: 17},
		{ctor: '_Tuple2', _0: 5, _1: 16},
		{ctor: '_Tuple2', _0: 5.5, _1: 15},
		{ctor: '_Tuple2', _0: 6.5, _1: 14},
		{ctor: '_Tuple2', _0: 7.5, _1: 13},
		{ctor: '_Tuple2', _0: 8, _1: 12}
	]);
var _terezka$elm_plot$MultiLineChart$data1 = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 0, _1: 8},
		{ctor: '_Tuple2', _0: 1, _1: 13},
		{ctor: '_Tuple2', _0: 2, _1: 14},
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							{ctor: '_Tuple2', _0: 'margin', _1: '100px auto 10px'}
						]))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									{ctor: '_Tuple2', _0: 'color', _1: '#9ea0a2'},
									{ctor: '_Tuple2', _0: 'font-size', _1: '12px'},
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('View code snippet')
						])),
					A2(
					_elm_lang$html$Html$div,
					_elm_lang$core$Native_List.fromArray(
						...
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html$text(codeString)
										]))
								])),
							A2(
								...
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											...
											{ctor: '_Tuple2', _0: 'margin', _1: '15px 20px'}
										])),
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('See full code')
								]))
						]))
				]));
	});
	...
	return A2(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						{ctor: '_Tuple2', _0: 'margin', _1: '80px auto'},
						{ctor: '_Tuple2', _0: 'font-family', _1: 'sans-serif'},
						{ctor: '_Tuple2', _0: 'color', _1: '#7F7F7F'},
						{ctor: '_Tuple2', _0: 'font-weight', _1: '200'},
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Elm Plot')
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								{ctor: '_Tuple2', _0: 'margin', _1: '40px auto 100px'}
							]))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Find it on '),
						A2(
						_elm_lang$html$Html$a,
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$href('https://github.com/terezka/elm-plot'),
								_elm_lang$html$Html_Attributes$style(
								_elm_lang$core$Native_List.fromArray(
									[
										{ctor: '_Tuple2', _0: 'color', _1: '#84868a'}
									]))
							]),
						_elm_lang$core$Native_List.fromArray(
							[
				...
				A4(_terezka$elm_plot$Docs$viewTitle, model, 'Simple Area Chart', 'AreaChart', _terezka$elm_plot$AreaChart$code),
				_terezka$elm_plot$AreaChart$chart,
				A4(_terezka$elm_plot$Docs$viewTitle, model, 'Multi Area Chart', 'MultiAreaChart', _terezka$elm_plot$MultiAreaChart$code),
				_terezka$elm_plot$MultiAreaChart$chart,
				A4(_terezka$elm_plot$Docs$viewTitle, model, 'Line Chart', 'MultiLineChart', _terezka$elm_plot$MultiLineChart$code),
				_terezka$elm_plot$MultiLineChart$chart,
				A4(_terezka$elm_plot$Docs$viewTitle, model, 'Grid', 'GridChart', _terezka$elm_plot$GridChart$code),
				_terezka$elm_plot$GridChart$chart,
				A4(_terezka$elm_plot$Docs$viewTitle, model, 'Custom ticks and labels', 'CustomTickChart', _terezka$elm_plot$CustomTickChart$code),
				_terezka$elm_plot$CustomTickChart$chart,
				A4(_terezka$elm_plot$Docs$viewTitle, model, 'Composable', 'ComposedChart', _terezka$elm_plot$ComposedChart$code),
				_terezka$elm_plot$ComposedChart$chart,
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								{ctor: '_Tuple2', _0: 'margin', _1: '100px auto 30px'},
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$href('https://twitter.com/terexka'),
								_elm_lang$html$Html_Attributes$style(
								_elm_lang$core$Native_List.fromArray(
									[
										{ctor: '_Tuple2', _0: 'color', _1: '#84868a'}
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('@terexka')
							]))
					]))
			]));
};
var _terezka$elm_plot$Docs$main = {
...
var Elm = {};
Elm['Docs'] = Elm['Docs'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Docs'], 'Docs', typeof _terezka$elm_plot$Docs$main === 'undefined' ? null : _terezka$elm_plot$Docs$main);
