				...
				A2(
					...
					_elm_lang$core$List$head(
						A2(
							...
							function (_p3) {
								var _p4 = _p3;
								return _elm_lang$core$Native_Utils.eq(_p2._0, _p4._0);
							},
							indexedLabels))));
		};
		return _elm_lang$core$Native_Utils.update(
							...
							F2(
								function (i, group) {
									return {
										ctor: '_Tuple2',
										_0: i,
										_1: _elm_lang$core$Maybe$Just(group)
									};
								}),
							groups)))));
	});
var _terezka$elm_plot$Internal_Bars$toPoint = F3(
	function (_p2, index, group) {
		var _p3 = _p2;
		return _elm_lang$core$Native_Utils.eq(_p3.stackBy, _terezka$elm_plot$Internal_Types$X) ? {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Basics$toFloat(index),
			_1: _terezka$elm_plot$Internal_Stuff$getHighest(group)
		} : {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Basics$toFloat(index),
			_1: _elm_lang$core$List$sum(group)
		};
	});
var _terezka$elm_plot$Internal_Bars$toPoints = F2(
	function (config, groups) {
		return A2(
			_elm_lang$core$List$indexedMap,
			_terezka$elm_plot$Internal_Bars$toPoint(config),
			groups);
	});
var _terezka$elm_plot$Internal_Bars$toBarWidth = F3(
	function (_p4, groups, $default) {
		var _p5 = _p4;
		var _p6 = _p5.maxWidth;
		if (_p6.ctor === 'Percentage') {
			return ($default * _elm_lang$core$Basics$toFloat(_p6._0)) / 100;
		} else {
			var _p7 = _p6._0;
			return (_elm_lang$core$Native_Utils.cmp(
				$default,
				_elm_lang$core$Basics$toFloat(_p7)) > 0) ? _elm_lang$core$Basics$toFloat(_p7) : $default;
		}
	});
var _terezka$elm_plot$Internal_Bars$toAutoWidth = F4(
	function (_p9, _p8, styleConfigs, groups) {
		var _p10 = _p9;
		var _p12 = _p10.scale;
		var _p11 = _p8;
		var width = 1 / _elm_lang$core$Basics$toFloat(
			_elm_lang$core$List$length(styleConfigs));
		return (width * _p12.x.length) / _p12.x.range;
	});
var _terezka$elm_plot$Internal_Bars$viewRect = F4(
	function (styleConfig, _p13, width, height) {
		var _p14 = _p13;
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					_elm_lang$svg$Svg$g,
					{
						...
						_0: _elm_lang$svg$Svg_Attributes$transform(
							_terezka$elm_plot$Internal_Draw$toTranslate(
								{ctor: '_Tuple2', _0: _p18 + (_p17 / 2), _1: _p19 - 5})),
						_1: {
							ctor: '::',
...
var _terezka$elm_plot$Internal_Bars$getPropsStackedY = F8(
	function (meta, config, styleConfigs, width, groupIndex, group, index, yValue) {
		...
		var offsetBar = function () {
			var amountOfNegatives = _elm_lang$core$List$length(
				A2(
					_elm_lang$core$List$filter,
					function (y) {
					...
					group));
			return (_elm_lang$core$Native_Utils.cmp(yValue, 0) > 0) ? _elm_lang$core$List$sum(
				A2(
					_elm_lang$core$List$take,
					index - amountOfNegatives,
					A2(_elm_lang$core$List$drop, amountOfNegatives, group))) : _elm_lang$core$List$sum(
				A2(_elm_lang$core$List$take, index, group));
		}();
		var _p20 = meta.toSvgCoords(
			{
				ctor: '_Tuple2',
				_0: _elm_lang$core$Basics$toFloat(groupIndex),
				_1: yValue + offsetBar
			});
		var xSvgPure = _p20._0;
		var ySvg = _p20._1;
		var offsetGroup = width / 2;
		var xSvg = xSvgPure - offsetGroup;
		return {
			ctor: '_Tuple4',
			_0: width,
			_1: _elm_lang$core$Basics$abs(height),
			_2: {ctor: '_Tuple2', _0: xSvg, _1: ySvg + heightOffset},
			_3: label
		};
	});
var _terezka$elm_plot$Internal_Bars$sortStackedY = F2(
	function (a, b) {
		return (((_elm_lang$core$Native_Utils.cmp(a, 0) > 0) && (_elm_lang$core$Native_Utils.cmp(b, 0) < 1)) || ((_elm_lang$core$Native_Utils.cmp(b, 0) > 0) && (_elm_lang$core$Native_Utils.cmp(a, 0) < 1))) ? A2(_elm_lang$core$Basics$compare, a, b) : _elm_lang$core$Basics$EQ;
	});
var _terezka$elm_plot$Internal_Bars$viewGroupStackedY = F6(
	function (meta, config, styleConfigs, width, groupIndex, group) {
		var sortedBarsValues = A2(
			...
			A2(
				...
				F2(
					function (_p22, _p21) {
						var _p23 = _p22;
						var _p24 = _p21;
						return A2(_terezka$elm_plot$Internal_Bars$sortStackedY, _p23._0, _p24._0);
					}),
				A3(
					_elm_lang$core$List$map2,
					F2(
					...
					group,
					styleConfigs)));
		var _p25 = _elm_lang$core$List$unzip(sortedBarsValues);
		var groupSorted = _p25._0;
		var styleConfigsSorted = _p25._1;
		var props = A2(
			_elm_lang$core$List$indexedMap,
			A6(_terezka$elm_plot$Internal_Bars$getPropsStackedY, meta, config, styleConfigs, width, groupIndex, groupSorted),
			groupSorted);
		return A2(
			_elm_lang$svg$Svg$g,
			{ctor: '[]'},
			A3(_elm_lang$core$List$map2, _terezka$elm_plot$Internal_Bars$viewBar, props, styleConfigsSorted));
	});
var _terezka$elm_plot$Internal_Bars$getPropsStackedX = F7(
	function (meta, config, styleConfigs, width, groupIndex, index, yValue) {
		var label = A2(config.labelView, index, yValue);
		var _p26 = meta.toSvgCoords(
			{
				ctor: '_Tuple2',
				_0: _elm_lang$core$Basics$toFloat(groupIndex),
				_1: yValue
			});
		var xSvgPure = _p26._0;
		var ySvg = _p26._1;
		var offsetBar = _elm_lang$core$Basics$toFloat(index) * width;
		var offsetGroup = (_elm_lang$core$Basics$toFloat(
			_elm_lang$core$List$length(styleConfigs)) * width) / 2;
		var xSvg = (xSvgPure - offsetGroup) + offsetBar;
		var _p27 = meta.toSvgCoords(
			{ctor: '_Tuple2', _0: 0, _1: 0});
		var originY = _p27._1;
		var height = _elm_lang$core$Basics$abs(originY - ySvg);
		return {
			ctor: '_Tuple4',
			_0: width,
			_1: height,
			_2: {
				ctor: '_Tuple2',
				_0: xSvg,
				_1: A2(_elm_lang$core$Basics$min, originY, ySvg)
			},
			_3: label
		};
	});
var _terezka$elm_plot$Internal_Bars$viewGroupStackedX = F6(
	function (_p28, config, styleConfigs, width, groupIndex, group) {
		var _p29 = _p28;
		var props = A2(
			_elm_lang$core$List$indexedMap,
			A5(_terezka$elm_plot$Internal_Bars$getPropsStackedX, _p29, config, styleConfigs, width, groupIndex),
			group);
		return A2(
			_elm_lang$svg$Svg$g,
			{ctor: '[]'},
...
var _terezka$elm_plot$Internal_Bars$view = F4(
	function (meta, config, styleConfigs, groups) {
		var viewGroup = function () {
			var _p30 = config.stackBy;
			if (_p30.ctor === 'X') {
				return _terezka$elm_plot$Internal_Bars$viewGroupStackedX;
			} else {
				return _terezka$elm_plot$Internal_Bars$viewGroupStackedY;
			}
		}();
		var width = A3(
...
var _terezka$elm_plot$Internal_Scale$getScale = F5(
	function (lengthTotal, restrictRange, offset, _p10, values) {
		var _p11 = _p10;
		var highest = restrictRange.upper(
			_terezka$elm_plot$Internal_Stuff$getHighest(values));
		var lowest = restrictRange.lower(
...
var _terezka$elm_plot$Plot$foldPoints = F2(
	function (element, allPoints) {
		...
		switch (_p8.ctor) {
			case 'Area':
				return A2(_elm_lang$core$Basics_ops['++'], allPoints, _p8._1);
			case 'Line':
				return A2(_elm_lang$core$Basics_ops['++'], allPoints, _p8._1);
			case 'Scatter':
				return A2(_elm_lang$core$Basics_ops['++'], allPoints, _p8._1);
			case 'Bars':
				return A2(
					_elm_lang$core$Basics_ops['++'],
					allPoints,
					A2(_terezka$elm_plot$Internal_Bars$toPoints, _p8._0, _p8._2));
			default:
				return allPoints;
		}
	});
var _terezka$elm_plot$Plot$toValuesOriented = function (elements) {
	return function (_p9) {
		var _p10 = _p9;
		return A2(_terezka$elm_plot$Internal_Types$Oriented, _p10._0, _p10._1);
	}(
...
var _terezka$elm_plot$Plot$calculateMeta = F2(
	function (_p11, elements) {
		var _p12 = _p11;
		var _p14 = _p12.size;
		var _p13 = _p12.margin;
		var top = _p13._0;
		var right = _p13._1;
		var bottom = _p13._2;
		var left = _p13._3;
		...
		switch (_p17.ctor) {
			case 'Line':
				return {
					...
					_0: {
						ctor: '::',
						_0: A3(_terezka$elm_plot$Internal_Line$view, meta, _p17._0, _p17._1),
						_1: _p20
					},
					_1: _p19
				};
			case 'Area':
				return {
					...
					_0: {
						ctor: '::',
						_0: A3(_terezka$elm_plot$Internal_Area$view, meta, _p17._0, _p17._1),
						_1: _p20
					},
					_1: _p19
				};
			case 'Scatter':
				return {
					...
					_0: {
						ctor: '::',
						_0: A3(_terezka$elm_plot$Internal_Scatter$view, meta, _p17._0, _p17._1),
						_1: _p20
					},
					_1: _p19
				};
			case 'Bars':
				return {
					...
					_0: {
						ctor: '::',
						_0: A4(_terezka$elm_plot$Internal_Bars$view, meta, _p17._0, _p17._1, _p17._2),
						_1: _p20
					},
					_1: _p19
				};
				...
				return {
					...
					_0: {
						...
						_0: A2(
							...
							A2(_terezka$elm_plot$Plot$getFlippedMeta, _p17._0.orientation, meta),
							_p17._0),
						_1: _p20
					},
					_1: _p19
			...
			default:
				...
				if (_p18.ctor === 'Just') {
					return {
						...
						_1: {
							ctor: '::',
							_0: A3(_terezka$elm_plot$Internal_Hint$view, meta, _p17._0, _p18._0),
							_1: _p19
						}
					};
				} else {
...
var _terezka$elm_plot$Plot$sizeStyle = function (_p21) {
	var _p22 = _p21;
	return {
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
			_0: 'height',
			_1: _terezka$elm_plot$Internal_Draw$toPixels(_p22.y)
		},
		_1: {
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'width',
				_1: _terezka$elm_plot$Internal_Draw$toPixels(_p22.x)
			},
			_1: {ctor: '[]'}
		}
	};
...
var _terezka$elm_plot$Plot$plotAttributes = function (_p25) {
	var _p26 = _p25;
	return {
		ctor: '::',
		...
		_1: {
			...
			_0: _elm_lang$html$Html_Attributes$style(
				A2(
					_elm_lang$core$Basics_ops['++'],
					_terezka$elm_plot$Plot$sizeStyle(_p26.size),
					_p26.style)),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$id(_p26.id),
				_1: {ctor: '[]'}
			}
		}
	};
...
var _terezka$elm_plot$Plot$viewPlot = F3(
	function (_p28, meta, _p27) {
		var _p29 = _p28;
		var _p30 = _p27;
		return A2(
			_elm_lang$html$Html$div,
			_terezka$elm_plot$Plot$plotAttributes(_p29),
			{
				ctor: '::',
				_0: A2(_terezka$elm_plot$Plot$viewSvg, _p29.size, _p30._0),
				_1: _p30._1
			});
	});
			...
			_1: {
				...
				_1: {
					...
					_0: _terezka$elm_plot$Plot$domainLowest(
						_elm_lang$core$Basics$always(-10)),
					_1: {
						ctor: '::',
