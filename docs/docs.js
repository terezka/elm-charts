					...
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {scale: a, ticks: b, toSvgCoords: c, fromSvgCoords: d, oppositeTicks: e, oppositeScale: f, oppositeToSvgCoords: g, getHintInfo: h, toNearestX: i, id: j};
									};
								};
							};
						};
...
var _terezka$elm_plot$Internal_Tick$filterValues = F2(
...
var _terezka$elm_plot$Internal_Tick$getValues = F2(
	function (_p4, scale) {
		var _p5 = _p4;
		return A2(
			_terezka$elm_plot$Internal_Tick$filterValues,
			_p5.removeZero,
			A2(_terezka$elm_plot$Internal_Tick$getRawValues, _p5.valueConfig, scale));
	});
...
var _terezka$elm_plot$Internal_Tick$Config = F3(
	function (a, b, c) {
		return {viewConfig: a, valueConfig: b, removeZero: c};
	});
var _terezka$elm_plot$Internal_Tick$StyleConfig = F4(
	function (a, b, c, d) {
...
var _terezka$elm_plot$Internal_Label$defaultStyleY = {
	ctor: '_Tuple2',
	_0: {
		ctor: '::',
...
var _terezka$elm_plot$Internal_Label$defaultStyleX = {
	ctor: '_Tuple2',
	_0: {
		ctor: '::',
...
var _terezka$elm_plot$Internal_Label$defaultView = F3(
	function (_p2, orientation, _p1) {
		...
		var _p5 = A3(
			...
			orientation,
			_terezka$elm_plot$Internal_Label$defaultStyleX,
			_terezka$elm_plot$Internal_Label$defaultStyleY);
		var defaultStyle = _p5._0;
		var defaultDisplacement = _p5._1;
		var _p6 = A2(_elm_lang$core$Maybe$withDefault, defaultDisplacement, _p3.displace);
		var dx = _p6._0;
		var dy = _p6._1;
		return A2(
				...
				_1: {
					...
					_0: _elm_lang$svg$Svg_Attributes$style(
						_terezka$elm_plot$Helpers$toStyle(
							A2(_elm_lang$core$Basics_ops['++'], defaultStyle, _p3.style))),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$class(
							A2(
...
var _terezka$elm_plot$Internal_Label$toViewFromStyleDynamic = F3(
	function (toStyleAttributes, orientation, _p7) {
		var _p8 = _p7;
		var _p10 = _p8._1;
		var _p9 = _p8._0;
		return A3(
...
var _terezka$elm_plot$Internal_Label$toView = function (config) {
	...
	switch (_p11.ctor) {
		case 'FromStyle':
			return _terezka$elm_plot$Internal_Label$defaultView(_p11._0);
		case 'FromStyleDynamic':
			return _terezka$elm_plot$Internal_Label$toViewFromStyleDynamic(_p11._0);
		default:
			return _p11._0;
	}
};
var _terezka$elm_plot$Internal_Label$defaultStyleConfig = {
	...
	format: function (_p12) {
		var _p13 = _p12;
		return _elm_lang$core$Basics$toString(_p13._1);
	},
	style: {ctor: '[]'},
	classes: {ctor: '[]'}
};
...
var _terezka$elm_plot$Internal_Draw$fullLine = F3(
	function (attributes, _p4, value) {
		var _p5 = _p4;
		var _p7 = _p5.toSvgCoords;
		var _p6 = _p5.scale;
		var lowest = _p6.lowest;
		var highest = _p6.highest;
		var begin = _p7(
...
var _terezka$elm_plot$Internal_Axis$placeTick = F4(
	function ($class, _p1, view, _p0) {
		var _p2 = _p1;
		var _p3 = _p0;
		var _p4 = _p3._1;
		return A2(
			_elm_lang$svg$Svg$g,
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$class(
						A2(_elm_lang$core$Basics_ops['++'], 'elm-plot__axis__', $class)),
					_1: {ctor: '[]'}
				}
			},
			{
				ctor: '::',
				_0: view(
					{ctor: '_Tuple2', _0: _p3._0, _1: _p4}),
				_1: {ctor: '[]'}
			});
	});
var _terezka$elm_plot$Internal_Axis$viewTicks = F4(
	function ($class, meta, view, values) {
		return A2(
			_elm_lang$svg$Svg$g,
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$class(
					A2(
						_elm_lang$core$Basics_ops['++'],
						'elm-plot__axis__',
						A2(_elm_lang$core$Basics_ops['++'], $class, 's'))),
				_1: {ctor: '[]'}
			},
			A2(
				_elm_lang$core$List$map,
				A3(_terezka$elm_plot$Internal_Axis$placeTick, $class, meta, view),
				values));
	});
var _terezka$elm_plot$Internal_Axis$viewAxisLine = function (_p5) {
	var _p6 = _p5;
	return _terezka$elm_plot$Internal_Draw$fullLine(
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$style(
				_terezka$elm_plot$Helpers$toStyle(_p6.lineStyle)),
			_1: {
				ctor: '::',
...
var _terezka$elm_plot$Internal_Axis$view = F2(
	function (_p8, _p7) {
		...
		var _p15 = _p9;
		var _p10 = _p7;
		var _p14 = _p10.viewConfig;
		var _p13 = _p10.tickConfig;
		var _p12 = _p10.orientation;
		var _p11 = _p10.labelConfig;
		var tickValues = A2(_terezka$elm_plot$Internal_Tick$getValuesIndexed, _p13, _p9.scale);
		var labelValues = A2(_terezka$elm_plot$Internal_Label$getValuesIndexed, _p11.valueConfig, tickValues);
		return A2(
			_elm_lang$svg$Svg$g,
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$style(
					_terezka$elm_plot$Helpers$toStyle(_p14.baseStyle)),
				_1: {
					ctor: '::',
					_0: A3(_terezka$elm_plot$Internal_Draw$classAttributeOriented, 'axis', _p12, _p14.classes),
					_1: {ctor: '[]'}
				}
			},
			{
				ctor: '::',
				_0: A3(_terezka$elm_plot$Internal_Axis$viewAxisLine, _p14, _p15, 0),
				_1: {
					ctor: '::',
					_0: A4(
						_terezka$elm_plot$Internal_Axis$viewTicks,
						'tick',
						_p15,
						A2(_terezka$elm_plot$Internal_Tick$toView, _p13.viewConfig, _p12),
						tickValues),
					_1: {
						ctor: '::',
						_0: A4(
							...
							'label',
							_p15,
							A2(_terezka$elm_plot$Internal_Label$toView, _p11.viewConfig, _p12),
							labelValues),
						_1: {ctor: '[]'}
					}
				}
...
var _terezka$elm_plot$Internal_Axis$defaultConfigX = {tickConfig: _terezka$elm_plot$Internal_Tick$defaultConfig, labelConfig: _terezka$elm_plot$Internal_Label$defaultConfig, viewConfig: _terezka$elm_plot$Internal_Axis$defaultStyleConfig, orientation: _terezka$elm_plot$Plot_Types$X};
...
var _terezka$elm_plot$Internal_Axis$StyleConfig = F3(
	function (a, b, c) {
...
var _terezka$elm_plot$Internal_Grid$viewLine = function (style) {
	return _terezka$elm_plot$Internal_Draw$fullLine(
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$style(
...
var _terezka$elm_plot$Internal_Grid$view = F2(
	function (meta, _p1) {
		...
		var _p3 = meta;
		var scale = _p3.scale;
		var toSvgCoords = _p3.toSvgCoords;
		var oppositeTicks = _p3.oppositeTicks;
		var positions = A2(_terezka$elm_plot$Internal_Grid$getValues, oppositeTicks, _p2.values);
		return A2(
			_elm_lang$svg$Svg$g,
			{
				ctor: '::',
				_0: A3(_terezka$elm_plot$Internal_Draw$classAttributeOriented, 'grid', _p2.orientation, _p2.classes),
				_1: {ctor: '[]'}
			},
			A2(
				_elm_lang$core$List$map,
				A2(_terezka$elm_plot$Internal_Grid$viewLine, _p2.style, meta),
				positions));
	});
var _terezka$elm_plot$Internal_Grid$Config = F4(
	function (a, b, c, d) {
...
var _terezka$elm_plot$Plot_Grid$style = F2(
	function (style, config) {
		return _elm_lang$core$Native_Utils.update(
			config,
			{
				style: A2(_elm_lang$core$Basics_ops['++'], _terezka$elm_plot$Internal_Grid$defaultConfigX.style, style)
			});
	});
...
var _terezka$elm_plot$Internal_Area$Config = function (a) {
	return {style: a};
};
...
var _terezka$elm_plot$Plot$unScaleValue = F2(
	function (_p6, v) {
		var _p7 = _p6;
		return (((v - _p7.offset) * _p7.range) / _p7.length) + _p7.lowest;
	});
		...
		switch (_p31.ctor) {
			case 'Line':
				return {
					...
					_0: {
						ctor: '::',
						_0: A3(_terezka$elm_plot$Internal_Line$view, meta, _p31._0, _p31._1),
						_1: _p34
					},
					_1: _p33
				};
			case 'Area':
				return {
					...
					_0: {
						ctor: '::',
						_0: A3(_terezka$elm_plot$Internal_Area$view, meta, _p31._0, _p31._1),
						_1: _p34
					},
					_1: _p33
				};
			...
			default:
				...
				if (_p32.ctor === 'Just') {
					return {
						...
						_1: {
							ctor: '::',
							_0: A3(_terezka$elm_plot$Internal_Hint$view, meta, _p31._0, _p32._0),
							_1: _p33
						}
					};
				} else {
...
var _terezka$elm_plot$Plot$sizeStyle = function (_p35) {
	var _p36 = _p35;
	return {
		ctor: '::',
		_0: {
...
var _terezka$elm_plot$Plot$plotAttributes = function (_p39) {
	var _p40 = _p39;
	return {
		ctor: '::',
		...
		_1: {
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$style(
				_terezka$elm_plot$Plot$sizeStyle(_p40.size)),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$id(_p40.id),
				_1: {ctor: '[]'}
			}
		}
	};
...
var _terezka$elm_plot$Plot$viewPlot = F3(
	function (_p42, meta, _p41) {
		var _p43 = _p42;
		var _p44 = _p41;
		return A2(
			_elm_lang$html$Html$div,
			_terezka$elm_plot$Plot$plotAttributes(_p43),
			{
				ctor: '::',
				_0: A2(_terezka$elm_plot$Plot$viewSvg, _p43.size, _p44._0),
				_1: _p44._1
			});
	});
...
var _terezka$elm_plot$Plot$getRelativePosition = F4(
	function (_p46, _p45, left, top) {
		var _p47 = _p46;
		var _p48 = _p45;
		var _p49 = _p47.fromSvgCoords(
			{ctor: '_Tuple2', _0: _p48._0 - left, _1: _p48._1 - top});
		var x = _p49._0;
		var y = _p49._1;
		return {
			ctor: '_Tuple2',
			_0: _p47.toNearestX(x),
			_1: y
		};
	});
...
var _terezka$elm_plot$Plot$horizontalGrid = function (attrs) {
	return _terezka$elm_plot$Plot$Grid(
		A2(_terezka$elm_plot$Helpers$foldConfig, _terezka$elm_plot$Internal_Grid$defaultConfigX, attrs));
};
var _terezka$elm_plot$Plot$verticalGrid = function (attrs) {
	return _terezka$elm_plot$Plot$Grid(
		A2(_terezka$elm_plot$Helpers$foldConfig, _terezka$elm_plot$Internal_Grid$defaultConfigY, attrs));
};
	...
	return A2(
		...
		},
		{
			...
			_0: _terezka$elm_plot$Plot$horizontalGrid(
				{
					ctor: '::',
					_0: _terezka$elm_plot$Plot_Grid$style(
						{
							ctor: '::',
			...
			_1: {
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: A2(_elm_lang$html$Html$map, _terezka$elm_plot$Docs$PlotInteraction, _terezka$elm_plot$AreaChart$chart),
							_1: {
								ctor: '::',
