...
var _terezka$elm_plot$Internal_Pile$addPadding = F2(
	function (_p0, padding) {
		var _p1 = _p0;
		return _elm_lang$core$Native_Utils.update(
			_p1,
			{lowest: _p1.lowest - padding, highest: _p1.highest + padding});
	});
var _terezka$elm_plot$Internal_Pile$calcPilePadding = function (_p2) {
	var _p3 = _p2;
	return (_p3.highest - _p3.lowest) / _elm_lang$core$Basics$toFloat((_p3.pointCount - 1) * 2);
};
var _terezka$elm_plot$Internal_Pile$mergeEdges = F2(
	function (_p4, edges) {
		...
		if (_p6.ctor === 'Just') {
			return _elm_lang$core$Maybe$Just(
				{
					lower: A2(_elm_lang$core$Basics$min, _p8, _p6._0.lower),
					upper: A2(_elm_lang$core$Basics$max, _p7, _p6._0.upper)
				});
		} else {
			return _elm_lang$core$Maybe$Just(
				{lower: _p8, upper: _p7});
	...
	function (_p19, elements) {
		...
		return function (pileMeta) {
			return A2(
				...
				pileMeta,
				_terezka$elm_plot$Internal_Pile$calcPilePadding(pileMeta));
		}(
			A3(
				_elm_lang$core$List$foldl,
			...
			case 'Pile':
				return A2(
					...
					A2(
						...
						function (_p4) {
							var _p5 = _p4;
							return A2(_terezka$elm_plot$Plot$collectYValue, xValue, _p5._1);
						},
						_p3._1));
			default:
				return yValues;
...
var _terezka$elm_plot$Plot$collectPileMetas = F2(
	function (element, allPileMetas) {
		var _p6 = element;
		if (_p6.ctor === 'Pile') {
			return {ctor: '::', _0: _p6._2, _1: allPileMetas};
		} else {
			return allPileMetas;
		}
	});
		...
		switch (_p7.ctor) {
			...
			case 'Pile':
				var points = A3(
					_elm_lang$core$List$foldr,
					F2(
						function (_p8, allBarPoints) {
							var _p9 = _p8;
							return A2(_elm_lang$core$Basics_ops['++'], allBarPoints, _p9._1);
						}),
					{ctor: '[]'},
					_p7._1);
				return A2(_elm_lang$core$Basics_ops['++'], allPoints, points);
			default:
				return allPoints;
		}
	});
...
var _terezka$elm_plot$Plot$collectAxisConfigs = F2(
	function (element, _p10) {
		var _p11 = _p10;
		var _p16 = _p11._1;
		var _p15 = _p11._0;
		var _p12 = element;
		if (_p12.ctor === 'Axis') {
			var _p14 = _p12._0;
			var _p13 = _p14.orientation;
			if (_p13.ctor === 'X') {
				return {
					ctor: '_Tuple2',
					_0: {ctor: '::', _0: _p14, _1: _p15},
					_1: _p16
				};
			} else {
				return {
...
var _terezka$elm_plot$Plot$unScaleValue = F2(
	function (_p17, v) {
		var _p18 = _p17;
		return (((v - _p18.offset) * _p18.range) / _p18.length) + _p18.lowest;
	});
var _terezka$elm_plot$Plot$fromSvgCoords = F3(
	function (xScale, yScale, _p19) {
		var _p20 = _p19;
		return {
			ctor: '_Tuple2',
			_0: A2(_terezka$elm_plot$Plot$unScaleValue, xScale, _p20._0),
			_1: A2(_terezka$elm_plot$Plot$unScaleValue, yScale, yScale.length - _p20._1)
		};
	});
var _terezka$elm_plot$Plot$scaleValue = F2(
	function (_p21, v) {
		var _p22 = _p21;
		return ((v * _p22.length) / _p22.range) + _p22.offset;
	});
var _terezka$elm_plot$Plot$toSvgCoordsX = F3(
	function (xScale, yScale, _p23) {
		var _p24 = _p23;
		return {
			ctor: '_Tuple2',
			_0: A2(
				...
				xScale,
				_elm_lang$core$Basics$abs(xScale.lowest) + _p24._0),
			_1: A2(_terezka$elm_plot$Plot$scaleValue, yScale, yScale.highest - _p24._1)
		};
	});
var _terezka$elm_plot$Plot$toSvgCoordsY = F3(
	function (xScale, yScale, _p25) {
		var _p26 = _p25;
		return A3(
			_terezka$elm_plot$Plot$toSvgCoordsX,
			xScale,
			yScale,
			{ctor: '_Tuple2', _0: _p26._1, _1: _p26._0});
	});
var _terezka$elm_plot$Plot$getAutoHighest = F2(
	function (pileEdges, highestFromValues) {
		var _p27 = pileEdges;
		if (_p27.ctor === 'Just') {
			return A2(_elm_lang$core$Basics$max, _p27._0.upper, highestFromValues);
		} else {
			return highestFromValues;
		}
	});
var _terezka$elm_plot$Plot$getScaleHighest = F3(
	function (forcedHighest, values, pileEdges) {
		var _p28 = forcedHighest;
		if (_p28.ctor === 'Just') {
			return _p28._0;
		} else {
			return A2(
				_terezka$elm_plot$Plot$getAutoHighest,
				pileEdges,
				_terezka$elm_plot$Internal_Stuff$getHighest(values));
		}
	});
var _terezka$elm_plot$Plot$getAutoLowest = F2(
	function (pileEdges, lowestFromValues) {
		var _p29 = pileEdges;
		if (_p29.ctor === 'Just') {
			return A2(_elm_lang$core$Basics$min, _p29._0.lower, lowestFromValues);
		} else {
			return lowestFromValues;
		}
	});
var _terezka$elm_plot$Plot$getScaleLowest = F3(
	function (forcedLowest, values, pileEdges) {
		var _p30 = forcedLowest;
		if (_p30.ctor === 'Just') {
			return _p30._0;
		} else {
			return A2(
				_terezka$elm_plot$Plot$getAutoLowest,
				pileEdges,
				_terezka$elm_plot$Internal_Stuff$getLowest(values));
		}
	});
var _terezka$elm_plot$Plot$getScale = F6(
	function (lengthTotal, _p33, _p32, _p31, values, pileEdges) {
		var _p34 = _p33;
		var _p35 = _p32;
		var _p37 = _p35._0;
		var _p36 = _p31;
		var highest = A3(_terezka$elm_plot$Plot$getScaleHighest, _p34._1, values, pileEdges);
		var lowest = A3(_terezka$elm_plot$Plot$getScaleLowest, _p34._0, values, pileEdges);
		var range = A2(_terezka$elm_plot$Internal_Stuff$getRange, lowest, highest);
		var length = (lengthTotal - _p37) - _p35._1;
		var paddingTop = A3(_terezka$elm_plot$Internal_Stuff$pixelsToValue, length, range, _p36._1);
		var paddingBottom = A3(_terezka$elm_plot$Internal_Stuff$pixelsToValue, length, range, _p36._0);
		return {lowest: lowest - paddingBottom, highest: highest + paddingTop, range: (range + paddingBottom) + paddingTop, length: length, offset: _p37};
	});
var _terezka$elm_plot$Plot$flipToY = function (_p38) {
	var _p39 = _p38;
	return _elm_lang$core$Native_Utils.update(
		_p39,
		{scale: _p39.oppositeScale, oppositeScale: _p39.scale, toSvgCoords: _p39.oppositeToSvgCoords, oppositeToSvgCoords: _p39.toSvgCoords, axisCrossings: _p39.oppositeAxisCrossings, oppositeAxisCrossings: _p39.axisCrossings, ticks: _p39.oppositeTicks, oppositeTicks: _p39.ticks});
};
var _terezka$elm_plot$Plot$getFlippedMeta = F2(
	function (orientation, meta) {
		var _p40 = orientation;
		if (_p40.ctor === 'X') {
			return meta;
		} else {
...
var _terezka$elm_plot$Plot$calculateMeta = F2(
	function (_p41, elements) {
		var _p42 = _p41;
		var _p43 = _p42.margin;
		var top = _p43._0;
		var right = _p43._1;
		var bottom = _p43._2;
		var left = _p43._3;
		...
		var _p45 = A3(
			_elm_lang$core$List$foldr,
			_terezka$elm_plot$Plot$collectAxisConfigs,
			{
				ctor: '_Tuple2',
				_0: {ctor: '[]'},
				_1: {ctor: '[]'}
			...
			elements);
		var xAxisConfigs = _p45._0;
		var yAxisConfigs = _p45._1;
		...
		var xScale = A6(
			...
			xValues,
			pileEdges.x);
		var xTicks = A2(_terezka$elm_plot$Plot$getLastGetTickValues, xAxisConfigs, xScale);
		var yScale = A6(
			_terezka$elm_plot$Plot$getScale,
			height,
			_p42.domain,
			...
			yValues,
			pileEdges.y);
		var yTicks = A2(_terezka$elm_plot$Plot$getLastGetTickValues, yAxisConfigs, yScale);
		return {
			scale: xScale,
			...
			axisCrossings: A2(_terezka$elm_plot$Plot$getAxisCrossings, xAxisConfigs, yScale),
			oppositeAxisCrossings: A2(_terezka$elm_plot$Plot$getAxisCrossings, yAxisConfigs, xScale),
			toNearestX: _terezka$elm_plot$Internal_Stuff$toNearest(xValues),
		...
		switch (_p49.ctor) {
			case 'Line':
				return {
					...
					_0: {
						ctor: '::',
						_0: A3(_terezka$elm_plot$Internal_Line$view, meta, _p49._0, _p49._1),
						_1: _p52
					},
					_1: _p51
				};
			case 'Area':
				return {
					...
					_0: {
						ctor: '::',
						_0: A3(_terezka$elm_plot$Internal_Area$view, meta, _p49._0, _p49._1),
						_1: _p52
					},
					_1: _p51
				};
			case 'Scatter':
				return {
					...
					_0: {
						ctor: '::',
						_0: A3(_terezka$elm_plot$Internal_Scatter$view, meta, _p49._0, _p49._1),
						_1: _p52
					},
					_1: _p51
				};
			case 'Pile':
				return {
					...
					_0: {
						ctor: '::',
						_0: A4(_terezka$elm_plot$Internal_Pile$view, meta, _p49._2, _p49._0, _p49._1),
						_1: _p52
					},
					_1: _p51
				};
				...
				return {
					...
					_0: {
						...
						_0: A2(
							...
							A2(_terezka$elm_plot$Plot$getFlippedMeta, _p49._0.orientation, meta),
							_p49._0),
						_1: _p52
					},
					_1: _p51
			...
			default:
				...
				if (_p50.ctor === 'Just') {
					return {
						...
						_1: {
							ctor: '::',
							_0: A3(_terezka$elm_plot$Internal_Hint$view, meta, _p49._0, _p50._0),
							_1: _p51
						}
					};
				} else {
					return {ctor: '_Tuple2', _0: _p52, _1: _p51};
				}
		}
	});
...
var _terezka$elm_plot$Plot$sizeStyle = function (_p53) {
	var _p54 = _p53;
	return {
		ctor: '::',
		_0: {
...
var _terezka$elm_plot$Plot$plotAttributes = function (_p57) {
	var _p58 = _p57;
	return {
		ctor: '::',
		...
		_1: {
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$style(
				_terezka$elm_plot$Plot$sizeStyle(_p58.size)),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$id(_p58.id),
				_1: {ctor: '[]'}
			}
		}
	};
...
var _terezka$elm_plot$Plot$viewPlot = F3(
	function (_p60, meta, _p59) {
		var _p61 = _p60;
		var _p62 = _p59;
		return A2(
			_elm_lang$html$Html$div,
			_terezka$elm_plot$Plot$plotAttributes(_p61),
			{
				ctor: '::',
				_0: A2(_terezka$elm_plot$Plot$viewSvg, _p61.size, _p62._0),
				_1: _p62._1
			});
	});
...
var _terezka$elm_plot$Plot$getRelativePosition = F4(
	function (_p64, _p63, left, top) {
		var _p65 = _p64;
		var _p66 = _p63;
		var _p67 = _p65.fromSvgCoords(
			{ctor: '_Tuple2', _0: _p66._0 - left, _1: _p66._1 - top});
		var x = _p67._0;
		var y = _p67._1;
		return {
			ctor: '_Tuple2',
			_0: _p65.toNearestX(x),
			_1: y
		};
	});
...
var _terezka$elm_plot$Plot$domain = F2(
...
var _terezka$elm_plot$Plot$defaultConfig = {
	...
	domain: {ctor: '_Tuple2', _0: _elm_lang$core$Maybe$Nothing, _1: _elm_lang$core$Maybe$Nothing},
	range: {ctor: '_Tuple2', _0: _elm_lang$core$Maybe$Nothing, _1: _elm_lang$core$Maybe$Nothing},
	id: 'elm-plot'
};
...
var _terezka$elm_plot$BarChart$formatter = function (_p0) {
	var _p1 = _p0;
		...
		A2(
			...
			_elm_lang$core$List$head(
				A2(
					...
					_terezka$elm_plot$BarChart$labels))));
};
var _terezka$elm_plot$BarChart$data = {
	ctor: '::',
...
var _terezka$elm_plot$BarChart$view = A2(
	_terezka$elm_plot$Plot$plot,
	{
		ctor: '::',
		_0: _terezka$elm_plot$Plot$size(
			{ctor: '_Tuple2', _0: 380, _1: 300}),
		_1: {
			ctor: '::',
			...
			_1: {
				ctor: '::',
				_0: _terezka$elm_plot$Plot$domain(
					{
						ctor: '_Tuple2',
		...
		_0: A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _terezka$elm_plot$Plot_Bars$fill(_terezka$elm_plot$Colors$blueFill),
						_1: {ctor: '[]'}
					},
					A2(
						_elm_lang$core$List$map,
						...
						_terezka$elm_plot$BarChart$data)),
				_1: {
					ctor: '::',
					_0: A2(
						_terezka$elm_plot$Plot_Pile$bars,
						{
							ctor: '::',
							_0: _terezka$elm_plot$Plot_Bars$fill(_terezka$elm_plot$Colors$skinFill),
							_1: {ctor: '[]'}
						},
						A2(
							_elm_lang$core$List$map,
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _terezka$elm_plot$Plot_Bars$fill(_terezka$elm_plot$Colors$pinkFill),
								_1: {ctor: '[]'}
							},
							_terezka$elm_plot$BarChart$data),
						_1: {ctor: '[]'}
			...
			_0: _terezka$elm_plot$Plot$xAxis(
				{
					...
					_0: _terezka$elm_plot$Plot_Axis$line(
						{
							ctor: '::',
							_0: _terezka$elm_plot$Plot_Line$stroke(_terezka$elm_plot$Colors$axisColor),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
							...
							_0: _terezka$elm_plot$Plot_Axis$label(
								{
									...
									_0: _terezka$elm_plot$Plot_Label$view(
										{
											ctor: '::',
											_0: _terezka$elm_plot$Plot_Label$format(_terezka$elm_plot$BarChart$formatter),
											_1: {
												ctor: '::',
...
var _terezka$elm_plot$BarChart$fileName = 'Bars';
var _terezka$elm_plot$BarChart$title = 'Bars';
var _terezka$elm_plot$BarChart$plotExample = {title: _terezka$elm_plot$BarChart$title, code: _terezka$elm_plot$BarChart$code, view: _terezka$elm_plot$BarChart$view, fileName: _terezka$elm_plot$BarChart$fileName};
...
var _terezka$elm_plot$ComposedChart$filterLabels = function (_p2) {
	var _p3 = _p2;
	return !_terezka$elm_plot$ComposedChart$isOdd(_p3._0);
};
var _terezka$elm_plot$ComposedChart$toTickStyle = function (_p4) {
	var _p5 = _p4;
	return _terezka$elm_plot$ComposedChart$isOdd(_p5._0) ? {
		ctor: '::',
...
var _terezka$elm_plot$ComposedChart$dataScat = {
	ctor: '::',
		...
		_terezka$elm_plot$Plot$plotInteractive,
		{
			...
			_1: {
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _terezka$elm_plot$Plot$id('ComposedChart'),
						_1: {ctor: '[]'}
					}
				}
			}
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _terezka$elm_plot$Plot_Area$stroke(_terezka$elm_plot$Colors$skinStroke),
								_1: {
									ctor: '::',
									_0: _terezka$elm_plot$Plot_Area$fill(_terezka$elm_plot$Colors$skinFill),
									_1: {
										ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _terezka$elm_plot$Plot_Area$stroke(_terezka$elm_plot$Colors$blueStroke),
									_1: {
										ctor: '::',
										_0: _terezka$elm_plot$Plot_Area$fill(_terezka$elm_plot$Colors$blueFill),
										_1: {ctor: '[]'}
									}
								},
								_terezka$elm_plot$ComposedChart$data1),
							_1: {
								...
								_1: {
									...
									_0: A2(
										_terezka$elm_plot$Plot$scatter,
										{ctor: '[]'},
										_terezka$elm_plot$ComposedChart$dataScat),
									_1: {
										ctor: '::',
															...
															_1: {
																...
																_1: {
																	...
																	_0: _terezka$elm_plot$Plot_Axis$label(
																		{
																			ctor: '::',
																			_0: _terezka$elm_plot$Plot_Label$view(_terezka$elm_plot$ComposedChart$labelStyle),
																			_1: {ctor: '[]'}
																		}),
																	_1: {ctor: '[]'}
																}
...
var _terezka$elm_plot$CustomTickChart$toTickStyle = function (_p0) {
	var _p1 = _p0;
	return _terezka$elm_plot$CustomTickChart$isOdd(_p1._0) ? {
		ctor: '::',
		_0: _terezka$elm_plot$Plot_Tick$length(7),
		_1: {
			ctor: '::',
...
var _terezka$elm_plot$CustomTickChart$toLabelStyle = function (_p2) {
	var _p3 = _p2;
	return _terezka$elm_plot$CustomTickChart$isOdd(_p3._0) ? {
		ctor: '::',
		_0: _terezka$elm_plot$Plot_Label$format(
			_elm_lang$core$Basics$always('')),
		_1: {ctor: '[]'}
...
var _terezka$elm_plot$CustomTickChart$view = A2(
	_terezka$elm_plot$Plot$plot,
	{
		ctor: '::',
		_0: _terezka$elm_plot$Plot$size(
			...
			_0: _terezka$elm_plot$Plot$xAxis(
				{
					...
					_1: {
						...
						_0: _terezka$elm_plot$Plot_Axis$tick(
							{
								ctor: '::',
								_0: _terezka$elm_plot$Plot_Tick$viewDynamic(_terezka$elm_plot$CustomTickChart$toTickStyle),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: _terezka$elm_plot$Plot_Axis$label(
								{
									ctor: '::',
									_0: _terezka$elm_plot$Plot_Label$viewDynamic(_terezka$elm_plot$CustomTickChart$toLabelStyle),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
var _terezka$elm_plot$CustomTickChart$fileName = 'CustomTickChart';
var _terezka$elm_plot$CustomTickChart$title = 'Custom ticks and labels';
var _terezka$elm_plot$CustomTickChart$plotExample = {title: _terezka$elm_plot$CustomTickChart$title, code: _terezka$elm_plot$CustomTickChart$code, view: _terezka$elm_plot$CustomTickChart$view, fileName: _terezka$elm_plot$CustomTickChart$fileName};
...
var _terezka$elm_plot$MultiAreaChart$view = A2(
	_terezka$elm_plot$Plot$plot,
	{
		ctor: '::',
		_0: _terezka$elm_plot$Plot$size(
...
var _terezka$elm_plot$MultiAreaChart$fileName = 'MultiAreaChart';
var _terezka$elm_plot$MultiAreaChart$title = 'Areas';
var _terezka$elm_plot$MultiAreaChart$plotExample = {title: _terezka$elm_plot$MultiAreaChart$title, code: _terezka$elm_plot$MultiAreaChart$code, view: _terezka$elm_plot$MultiAreaChart$view, fileName: _terezka$elm_plot$MultiAreaChart$fileName};
...
var _terezka$elm_plot$GridChart$view = A2(
	_terezka$elm_plot$Plot$plot,
	{
		ctor: '::',
		_0: _terezka$elm_plot$Plot$size(
		...
		_0: _terezka$elm_plot$Plot$verticalGrid(
			{
				...
				_0: _terezka$elm_plot$Plot_Grid$lines(
					{
						ctor: '::',
						_0: _terezka$elm_plot$Plot_Line$stroke(_terezka$elm_plot$Colors$axisColorLight),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}),
...
var _terezka$elm_plot$GridChart$fileName = 'GridChart';
var _terezka$elm_plot$GridChart$title = 'Grids';
var _terezka$elm_plot$GridChart$plotExample = {title: _terezka$elm_plot$GridChart$title, code: _terezka$elm_plot$GridChart$code, view: _terezka$elm_plot$GridChart$view, fileName: _terezka$elm_plot$GridChart$fileName};
...
var _terezka$elm_plot$MultiLineChart$view = A2(
	_terezka$elm_plot$Plot$plot,
	{
		ctor: '::',
		_0: _terezka$elm_plot$Plot$size(
...
var _terezka$elm_plot$MultiLineChart$fileName = 'MultiLineChart';
var _terezka$elm_plot$MultiLineChart$title = 'Lines';
var _terezka$elm_plot$MultiLineChart$plotExample = {title: _terezka$elm_plot$MultiLineChart$title, code: _terezka$elm_plot$MultiLineChart$code, view: _terezka$elm_plot$MultiLineChart$view, fileName: _terezka$elm_plot$MultiLineChart$fileName};
...
var _terezka$elm_plot$ScatterChart$view = A2(
	_terezka$elm_plot$Plot$plot,
	{
		ctor: '::',
		_0: _terezka$elm_plot$Plot$size(
	...
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _terezka$elm_plot$Plot_Scatter$stroke(_terezka$elm_plot$Colors$pinkStroke),
				_1: {
					ctor: '::',
					_0: _terezka$elm_plot$Plot_Scatter$fill(_terezka$elm_plot$Colors$pinkFill),
					_1: {
						ctor: '::',
...
var _terezka$elm_plot$ScatterChart$fileName = 'ScatterChart';
var _terezka$elm_plot$ScatterChart$title = 'Scatters';
var _terezka$elm_plot$ScatterChart$plotExample = {title: _terezka$elm_plot$ScatterChart$title, code: _terezka$elm_plot$ScatterChart$code, view: _terezka$elm_plot$ScatterChart$view, fileName: _terezka$elm_plot$ScatterChart$fileName};

var _terezka$elm_plot$HintChart$code = '\n    chart : Svg.Svg a\n    chart =\n        plot\n            [ size ( 600, 300 ) ]\n            [ line\n                [ Line.style\n                    [ ( \"stroke\", Colors.blueStroke )\n                    , ( \"stroke-width\", \"2px\" )\n                    ]\n                ]\n                data2\n            , line\n                [ Line.style\n                    [ ( \"stroke\", Colors.pinkStroke )\n                    , ( \"stroke-width\", \"2px\" )\n                    ]\n                ]\n                data1\n            , xAxis\n                [ Axis.view\n                    [ Axis.style [ ( \"stroke\", Colors.axisColor ) ] ]\n                ]\n            ]\n    ';
var _terezka$elm_plot$HintChart$data2 = {
	ctor: '::',
	_0: {ctor: '_Tuple2', _0: 0, _1: 0},
	_1: {
		ctor: '::',
...
var _terezka$elm_plot$HintChart$data1 = {
	ctor: '::',
	_0: {ctor: '_Tuple2', _0: 0, _1: 2},
	_1: {
		ctor: '::',
...
var _terezka$elm_plot$HintChart$view = function (state) {
	return A2(
		_terezka$elm_plot$Plot$plotInteractive,
		{
			ctor: '::',
			...
			_1: {
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _terezka$elm_plot$Plot$id('HintChart'),
						_1: {ctor: '[]'}
					}
				}
			}
		},
		{
			...
			_0: A2(
				...
				_terezka$elm_plot$HintChart$data1),
			_1: {
				ctor: '::',
				_0: A2(
					_terezka$elm_plot$Plot$line,
					...
					_terezka$elm_plot$HintChart$data2),
				_1: {
					ctor: '::',
					_0: _terezka$elm_plot$Plot$xAxis(
						{
...
var _terezka$elm_plot$HintChart$fileName = 'HintChart';
var _terezka$elm_plot$HintChart$title = 'Hints';
var _terezka$elm_plot$HintChart$plotExample = {title: _terezka$elm_plot$HintChart$title, code: _terezka$elm_plot$HintChart$code, view: _terezka$elm_plot$HintChart$view, fileName: _terezka$elm_plot$HintChart$fileName};
...
var _terezka$elm_plot$PlotAxis$toLabelAttrsY2 = function (_p0) {
	var _p1 = _p0;
	return {
		ctor: '::',
		_0: _terezka$elm_plot$Plot_Label$format(
			function (_p2) {
				...
				return A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Basics$toString(_p3._1 / 5),
					' k');
			}),
		_1: {ctor: '[]'}
	};
};
var _terezka$elm_plot$PlotAxis$isOdd = function (n) {
	return _elm_lang$core$Native_Utils.cmp(
		A2(_elm_lang$core$Basics$rem, n, 2),
		0) > 0;
};
var _terezka$elm_plot$PlotAxis$toTickStyle = function (_p4) {
	var _p5 = _p4;
	return _terezka$elm_plot$PlotAxis$isOdd(_p5._0) ? {
		ctor: '::',
		_0: _terezka$elm_plot$Plot_Tick$length(7),
		_1: {
			ctor: '::',
...
var _terezka$elm_plot$PlotAxis$toLabelAttrs = function (_p6) {
	var _p7 = _p6;
	return _terezka$elm_plot$PlotAxis$isOdd(_p7._0) ? {
		ctor: '::',
		_0: _terezka$elm_plot$Plot_Label$format(
			_elm_lang$core$Basics$always('')),
		_1: {ctor: '[]'}
...
var _terezka$elm_plot$PlotAxis$toLabelAttrsY1 = function (_p10) {
	var _p11 = _p10;
	return _terezka$elm_plot$PlotAxis$isOdd(_p11._0) ? {
		ctor: '::',
		_0: _terezka$elm_plot$Plot_Label$format(
			_elm_lang$core$Basics$always('')),
		_1: {ctor: '[]'}
		...
		_0: _terezka$elm_plot$Plot_Label$format(
			function (_p12) {
				...
				return A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Basics$toString(_p13._1 * 10),
					' x');
			}),
		_1: {
			ctor: '::',
		...
		_1: {
			...
			_1: {
				...
				_0: _terezka$elm_plot$Plot$domain(
					{
						ctor: '_Tuple2',
						_0: _elm_lang$core$Maybe$Just(-21),
						_1: _elm_lang$core$Maybe$Nothing
					}),
				_1: {ctor: '[]'}
			}
			...
			_0: _terezka$elm_plot$Plot$xAxis(
				{
					...
					_0: _terezka$elm_plot$Plot_Axis$tick(
						{
							ctor: '::',
							_0: _terezka$elm_plot$Plot_Tick$viewDynamic(_terezka$elm_plot$PlotAxis$toTickStyle),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: _terezka$elm_plot$Plot_Axis$label(
							{
								ctor: '::',
								_0: _terezka$elm_plot$Plot_Label$viewDynamic(_terezka$elm_plot$PlotAxis$toLabelAttrs),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							...
							_1: {
								...
								_1: {
									...
									_0: _terezka$elm_plot$Plot_Axis$label(
										{
											ctor: '::',
											_0: _terezka$elm_plot$Plot_Label$viewDynamic(_terezka$elm_plot$PlotAxis$toLabelAttrsY1),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
								...
								_1: {
									...
									_1: {
										...
										_0: _terezka$elm_plot$Plot_Axis$label(
											{
												ctor: '::',
												_0: _terezka$elm_plot$Plot_Label$viewDynamic(_terezka$elm_plot$PlotAxis$toLabelAttrsY2),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
...
var _terezka$elm_plot$PlotAxis$fileName = 'PlotAxis';
var _terezka$elm_plot$PlotAxis$title = 'Sticky axis';
var _terezka$elm_plot$PlotAxis$plotExample = {title: _terezka$elm_plot$PlotAxis$title, code: _terezka$elm_plot$PlotAxis$code, view: _terezka$elm_plot$PlotAxis$view, fileName: _terezka$elm_plot$PlotAxis$fileName};
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							_elm_lang$html$Html$map,
							_terezka$elm_plot$Docs$PlotInteraction(_terezka$elm_plot$Docs$EverythingExample),
							_terezka$elm_plot$ComposedChart$chart(model.everythingExample)),
						_1: {
							ctor: '::',
							_0: A2(_terezka$elm_plot$Docs$viewPlot, model, _terezka$elm_plot$ScatterChart$plotExample),
							_1: {
								ctor: '::',
								_0: A2(_terezka$elm_plot$Docs$viewPlot, model, _terezka$elm_plot$MultiLineChart$plotExample),
								_1: {
									ctor: '::',
									_0: A2(_terezka$elm_plot$Docs$viewPlot, model, _terezka$elm_plot$MultiAreaChart$plotExample),
									_1: {
										ctor: '::',
										_0: A2(_terezka$elm_plot$Docs$viewPlot, model, _terezka$elm_plot$GridChart$plotExample),
										_1: {
											ctor: '::',
											_0: A2(_terezka$elm_plot$Docs$viewPlot, model, _terezka$elm_plot$BarChart$plotExample),
											_1: {
												ctor: '::',
												_0: A2(_terezka$elm_plot$Docs$viewPlot, model, _terezka$elm_plot$CustomTickChart$plotExample),
												_1: {
													ctor: '::',
													_0: A2(_terezka$elm_plot$Docs$viewPlot, model, _terezka$elm_plot$PlotAxis$plotExample),
													_1: {
														ctor: '::',
														_0: A3(_terezka$elm_plot$Docs$viewPlotInteractive, model, model.hintExample, _terezka$elm_plot$HintChart$plotExample),
														_1: {
															ctor: '::',
															_0: A2(
																_elm_lang$html$Html$div,
