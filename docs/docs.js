...
var _terezka$elm_plot$Internal_Scale$getScaleHighest = F3(
	function (toHighest, values, pileEdges) {
		return toHighest(
			A2(
...
var _terezka$elm_plot$Internal_Scale$getScaleLowest = F3(
	function (toLowest, values, pileEdges) {
		return toLowest(
			A2(
...
var _terezka$elm_plot$Internal_Scale$getScale = F6(
	function (lengthTotal, restrictRange, _p13, _p12, values, pileEdges) {
		var _p14 = _p13;
		var _p16 = _p14._0;
		var _p15 = _p12;
		var highest = A3(_terezka$elm_plot$Internal_Scale$getScaleHighest, restrictRange.upper, values, pileEdges);
		var lowest = A3(_terezka$elm_plot$Internal_Scale$getScaleLowest, restrictRange.lower, values, pileEdges);
		var range = A2(_terezka$elm_plot$Internal_Stuff$getRange, lowest, highest);
		var length = (lengthTotal - _p16) - _p14._1;
		var paddingTop = A3(_terezka$elm_plot$Internal_Stuff$pixelsToValue, length, range, _p15._1);
		var paddingBottom = A3(_terezka$elm_plot$Internal_Stuff$pixelsToValue, length, range, _p15._0);
		return {lowest: lowest - paddingBottom, highest: highest + paddingTop, range: (range + paddingBottom) + paddingTop, length: length, offset: _p16};
	});
		...
		switch (_p19.ctor) {
			case 'Line':
				return {
					...
					_0: {
						ctor: '::',
						_0: A3(_terezka$elm_plot$Internal_Line$view, meta, _p19._0, _p19._1),
						_1: _p22
					},
					_1: _p21
				};
			case 'Area':
				return {
					...
					_0: {
						ctor: '::',
						_0: A3(_terezka$elm_plot$Internal_Area$view, meta, _p19._0, _p19._1),
						_1: _p22
					},
					_1: _p21
				};
			case 'Scatter':
				return {
					...
					_0: {
						ctor: '::',
						_0: A3(_terezka$elm_plot$Internal_Scatter$view, meta, _p19._0, _p19._1),
						_1: _p22
					},
					_1: _p21
				};
			case 'Pile':
				return {
					...
					_0: {
						ctor: '::',
						_0: A4(_terezka$elm_plot$Internal_Pile$view, meta, _p19._2, _p19._0, _p19._1),
						_1: _p22
					},
					_1: _p21
				};
				...
				return {
					...
					_0: {
						...
						_0: A2(
							...
							A2(_terezka$elm_plot$Plot$getFlippedMeta, _p19._0.orientation, meta),
							_p19._0),
						_1: _p22
					},
					_1: _p21
			...
			default:
				...
				if (_p20.ctor === 'Just') {
					return {
						...
						_1: {
							ctor: '::',
							_0: A3(_terezka$elm_plot$Internal_Hint$view, meta, _p19._0, _p20._0),
							_1: _p21
						}
					};
				} else {
					return {ctor: '_Tuple2', _0: _p22, _1: _p21};
				}
		}
	});
...
var _terezka$elm_plot$Plot$sizeStyle = function (_p23) {
	var _p24 = _p23;
	return {
		ctor: '::',
		_0: {
...
var _terezka$elm_plot$Plot$viewPlot = F3(
	function (_p30, meta, _p29) {
		var _p31 = _p30;
		var _p32 = _p29;
		return A2(
			_elm_lang$html$Html$div,
			_terezka$elm_plot$Plot$plotAttributes(_p31),
			{
				ctor: '::',
				_0: A2(_terezka$elm_plot$Plot$viewSvg, _p31.size, _p32._0),
				_1: _p32._1
			});
	});
...
var _terezka$elm_plot$Plot$getRelativePosition = F4(
	function (_p34, _p33, left, top) {
		var _p35 = _p34;
		var _p36 = _p33;
		var _p37 = _p35.fromSvgCoords(
			{ctor: '_Tuple2', _0: _p36._0 - left, _1: _p36._1 - top});
		var x = _p37._0;
		var y = _p37._1;
		return {
			ctor: '_Tuple2',
			_0: _p35.toNearestX(x),
			_1: y
		};
	});
var _terezka$elm_plot$Plot$shouldPositionUpdate = F2(
	function (_p39, _p38) {
		var _p40 = _p39;
		var _p43 = _p40.waiting;
		var _p41 = _p38;
		var _p42 = _p40.position;
		if (_p42.ctor === 'Nothing') {
			return _p43 && true;
		} else {
			return (_p43 && (!_elm_lang$core$Native_Utils.eq(_p42._0._1, _p41._1))) || (!_elm_lang$core$Native_Utils.eq(_p42._0._0, _p41._0));
		}
	});
var _terezka$elm_plot$Plot$getHoveredValue = function (_p44) {
	var _p45 = _p44;
	return _p45._0.position;
};
var _terezka$elm_plot$Plot$rangeHighest = F2(
	function (toHighest, _p46) {
		var _p47 = _p46;
		return _elm_lang$core$Native_Utils.update(
			_p47,
			{
		...
		return _elm_lang$core$Native_Utils.update(
			config,
			{
				size: A2(
					...
					_elm_lang$core$Basics$toFloat(_p57._0),
					_elm_lang$core$Basics$toFloat(_p57._1))
			});
	});
...
var _terezka$elm_plot$Plot$StateInner = F2(
	function (a, b) {
	...
	function (msg, _p60) {
		...
		switch (_p62.ctor) {
			...
			case 'ReceivePosition':
				...
				if (_p63.ctor === 'Ok') {
					var _p64 = _p63._0;
					return A2(_terezka$elm_plot$Plot$shouldPositionUpdate, _p65, _p64) ? {
						ctor: '_Tuple2',
						_0: _terezka$elm_plot$Plot$State(
							_elm_lang$core$Native_Utils.update(
								_p65,
						...
						ctor: '_Tuple2',
						_0: _terezka$elm_plot$Plot$State(_p65),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {
...
var _terezka$elm_plot$Plot$viewPlotInteractive = F3(
	function (_p67, meta, _p66) {
		...
		return A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				_terezka$elm_plot$Plot$plotAttributes(_p68),
				_terezka$elm_plot$Plot$plotAttributesInteraction(meta)),
			{
				ctor: '::',
				_0: A2(_terezka$elm_plot$Plot$viewSvg, _p68.size, _p69._0),
				_1: _p69._1
			});
	});
...
var _terezka$elm_plot$PlotHint$plotExample = {
	...
	fileName: _terezka$elm_plot$PlotHint$fileName,
	view: A2(_terezka$elm_plot$Common$ViewInteractive, _terezka$elm_plot$PlotHint$fileName, _terezka$elm_plot$PlotHint$view)
};
...
var _terezka$elm_plot$Docs$isCodeOpen = F2(
	function (_p0, title) {
		var _p1 = _p0;
...
var _terezka$elm_plot$Docs$viewCode = F3(
	function (model, id, codeString) {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$style(codeStyle),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('elm view-code'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
var _terezka$elm_plot$Docs$initialModel = {openSection: _elm_lang$core$Maybe$Nothing, plotStates: _elm_lang$core$Dict$empty};
...
var _terezka$elm_plot$Docs$Model = F2(
	function (a, b) {
		return {openSection: a, plotStates: b};
	});
		...
		while (true) {
			...
			if (_p5.ctor === 'Toggle') {
				...
				if (_p6.ctor === 'Internal') {
					var plotState = A2(_terezka$elm_plot$Docs$getPlotState, _p8, _p10);
					var _p7 = A2(_terezka$elm_plot$Plot$update, _p6._0, plotState);
					var newState = _p7._0;
					var cmd = _p7._1;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							_p9,
							{
								plotStates: A3(_terezka$elm_plot$Docs$setPlotState, _p8, newState, _p10)
							}),
						_1: A2(
							_elm_lang$core$Platform_Cmd$map,
							_terezka$elm_plot$Docs$PlotInteraction(_p8),
							cmd)
					};
				} else {
					var _v5 = _p6._0,
...
var _terezka$elm_plot$Docs$viewExampleInner = F2(
	function (plotStates, view) {
		var _p11 = view;
		if (_p11.ctor === 'ViewInteractive') {
			var _p12 = _p11._0;
			return A2(
				_elm_lang$html$Html$map,
				_terezka$elm_plot$Docs$PlotInteraction(_p12),
				_p11._1(
					A2(_terezka$elm_plot$Docs$getPlotState, _p12, plotStates)));
		} else {
			return _p11._0;
		}
	});
			...
			_1: {
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							_elm_lang$html$Html$map,
							_terezka$elm_plot$Docs$PlotInteraction(_terezka$elm_plot$PlotComposed$fileName),
							_terezka$elm_plot$PlotComposed$view(
								A2(_terezka$elm_plot$Docs$getPlotState, _terezka$elm_plot$PlotComposed$fileName, model.plotStates))),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$div,
